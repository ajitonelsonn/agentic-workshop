    ...
    for content_block in response_content_blocks:
        if "toolUse" in content_block:
            ...
            if tool_use_name == "cosine":
                ...
                min_val = tool_use_block["input"]["min"]
                max_val = tool_use_block["input"]["max"]
                ...
                follow_up_content_blocks.append(
                    {
                        "toolResult": {
                            "toolUseId": tool_use_block["toolUseId"],
                            "content": [{"json": {"result": random_num}}],
                        }
                    }
                )
    ...
    message_list = [
        {
            ...
            "content": [
                {
                    "text": "Generate a random number between 50 and 100, then calculate its cosine."
                }
            ],
        }
    ]
